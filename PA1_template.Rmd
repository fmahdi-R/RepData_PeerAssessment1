...
The mean of total steps per day is : `r tot_step_mean` 

The median of total steps per day is : `r tot_step_median` 
...
The mean of total steps per day for the imputed set is : `r imp_mean` 

The median of total steps per day for the imputed set is : `r imp_median` 
